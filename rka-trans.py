               ...
               try:
                       ...
                       for particle, particle_type in decompostion:
                                ...
                                if particle_type == 'prefix':
                                        ...
                                        color = 'magenta'
                                        #print(replace.replaceWord(word[idx:idx+len(particle)],particle_type), end='')
                                elif particle_type == 'pos_marker':
                                       color = 'white'
                                       #print(replace.replaceWord(word[idx:idx+len(particle)],particle_type), end='')

                                print(colored(replace.replaceWord(word[idx:idx+len(particle)],particle_type), color), end='')
                                idx += len(particle)
                                #print(particle_type)
               except:
